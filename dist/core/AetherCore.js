export class AetherSmoother {
    ...
    update(x, y, serverTimestamp, _localTime) {
        ...
        while (left < right) {
            ...
            if (this.history[mid].serverTs <= renderTime)
                left = mid;
            else
                right = mid - 1;
        }
    ...
    getJitter() { return Math.round(this._jitter * 100) / 100; }
    getBufferMs() { return Math.round(this.bufferMs); }
    getVelocity() { return { ...this.lastVelocity }; }
}
